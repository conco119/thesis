        ...
        <div class="x_content">
            <div class="row">
                <div class="col-md-9">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Lịch sử nhập hàng từ nhà cung cấp <b>{$supplier.name}</b>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <button type="button" data-toggle="modal" class="btn btn-default"
                                                data-target="#orderDetail" onclick="SetExportInfo({$list.id});">
                        ...
                        <div class="x_content">
                            ...
                            <div id="Filter">
                                <select class="form-control" id="filter" onchange="filter();">
                                    ...
                                    <select class="form-control" id="year" onchange="filter();"> {$out.year}
                                    </select>
                                    <select class="form-control" id="month" onchange="filter();">
                                        {$out.month}
                                    </select>
                                {/if} {if $out.value.filter eq '1'}
                                    <input type="text" class="form-control" id="date_from" placeholder="Từ ngày"
                                           onchange="filter();" value="{$out.date_from}">
                                    <input type="text" class="form-control" id="date_to" placeholder="Đến ngày"
                                           onchange="filter();" value="{$out.date_to}">
                                {/if}
                            </div>
