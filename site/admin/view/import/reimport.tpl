                ...
                <div id="">
                    <table class="table table-striped table-bordered" id="Products">
                        ...
                        <tr>
                            ...
                            <th>Đơn vị</th> {if $arg.setting.use_expiry eq 1}
                                <th class="text-center">HSD</th>
                            {/if} {if
                            $arg.setting.use_description_import eq 1}
                                <th class="text-right" width="120">Mô tả</th>
                            {/if}
                        ...
                        {foreach from=$products item=list}
                            <tr id="proNo{$list.id}">
                                ...
                                <td>{$list.select_units}</td> {if $arg.setting.use_expiry eq 1}
                                    <td>{$list.expiry}</td>{/if}
                                {if $arg.setting.use_description_import eq 1}
                                    <td class="text-right edit_desciption">
                                    <button type="button" id="test" class="btn btn-lg btn-info"
                                            data-html="true" data-toggle="popover" data-placement="left"
                                            onclick="SetValueDescripton({$list.id});"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" value="{$value.customer_name}"
                                ...
                                <div class="form-group">
									...
									<textarea class="form-control" rows="5"
                                              ...
                                              onchange="SetExportValue('description', this.value);">{$value.description}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
