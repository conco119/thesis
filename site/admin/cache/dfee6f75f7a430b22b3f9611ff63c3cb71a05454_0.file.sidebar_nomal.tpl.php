<?php
/* Smarty version 3.1.30, created on 2018-04-15 16:55:03
  from "/Users/mtd/Sites/htaccess/site/admin/view/layouts/includes/sidebar_nomal.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ad3217720a7c4_15788025',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dfee6f75f7a430b22b3f9611ff63c3cb71a05454' => 
    array (
      0 => '/Users/mtd/Sites/htaccess/site/admin/view/layouts/includes/sidebar_nomal.tpl',
      1 => 1514857578,
      2 => 'file',
    ),
  ),
...
function content_5ad3217720a7c4_15788025 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
images/img.jpg" alt="..." class="img-circle profile_img">
		...
		<div class="profile_info">
			<span>Xin chào,</span>
			<h2><?php echo $_smarty_tpl->tpl_vars['arg']->value['user']['short_name'];?>
</h2>
		</div>
	</div>
	<!-- /menu prile quick info -->
			...
			<ul class="nav side-menu">
				<li><a><i class="fa fa-dashboard"></i> Bàn làm việc <span class="fa fa-chevron-down"></span></a>
					<ul class="nav child_menu" style="display: none">
						...
						<li><a href="?mod=export&site=form">Bán hàng</a></li>
				...
				<li><a><i class="fa fa-recycle"></i> Sản phẩm<span class="fa fa-chevron-down"></span></a>
					<ul class="nav child_menu" style="display: none">
						...
						<?php if ($_smarty_tpl->tpl_vars['arg']->value['setting']['use_service'] == 1) {?><li><a href="?mod=service&site=index">Quản lý dịch vụ</a></li><?php }?>
