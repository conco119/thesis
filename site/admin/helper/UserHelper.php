...
class UserHelper
{
    ...
    public function get_user_permission_select($pdo, $user_permission)
    {
        $result = '';
    ...
    public function get_user_gender_select($pdo, $gender)
    {
        $result = '';
    ...
    public function get_user_code($pdo, $permission)
    {
        $rows = $pdo->count_rows("SELECT * FROM users where permission = $permission");
