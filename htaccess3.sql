...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th5 11, 2018 lúc 05:10 PM
...
INSERT INTO `customers` (`id`, `code`, `name`, `group_id`, `creator`, `gender`, `address`, `birthday`, `phone`, `email`, `status`, `created_at`, `updated_at`) VALUES
(1, 'CUSID1', 'Trần Anh Tú mua hàng', 2, 1, 1, 'Ha Noi', '2009-06-02', '12345671', '', 1, 0, 1526050042),
(2, 'CUSID2', 'dsads', 6, 1, 1, '', '1970-01-01', '', '', 1, 1526049749, 1526049960),
(4, 'CUSID3', 'eqw', 4, 1, 1, '', '1970-01-01', '', '', 1, 1526055924, 1526055924);
...
INSERT INTO `customer_groups` (`id`, `code`, `name`, `description`, `status`, `discount_type`, `discount`, `created_at`, `updated_at`) VALUES
(2, 'VIPP', 'Khách VipP', 'Vip VCL', 1, 2, 2, 1, 1526055742),
(4, 'saxs', 'cxz', '', 1, 3, 0, 1526017666, 1526055753),
(6, 'NN', 'Người Nhà', '', 1, 0, 0, 1526019279, 1526019279),
(9, 'VIP', 'VIP VCL', '', 1, 0, 0, 1526032830, 1526048554);
...
(1, 'CID0', 'Thức ăn cho chó', 1, 7, 0, 1525782249),
...
(13, 'CID8', 'Phim', 1, 0, 1525586328, 1525775735),
(14, 'CID9', 'Fat ', 1, 13, 1525586342, 1525586378),
(16, 'CID10', 'nothing', 1, 0, 1525586635, 1525799006),
(18, 'CID12', 'PHim VNx', 1, 13, 1525770513, 1525791447),
(22, 'CID13', 'Thể Thao', 1, 0, 1525771565, 1525791528),
(29, 'CID19', 'Tổ Lái', 1, 22, 1525771683, 1525799515);
...
(22, 'UID6', 'ax', 1, 1525770568, 1525770575);
...
INSERT INTO `users` (`id`, `code`, `username`, `password`, `name`, `gender`, `birthday`, `address`, `email`, `phone`, `status`, `permission`, `created_at`, `updated_at`, `avatar`) VALUES
(1, 'AD0', 'admin', '12345', 'Nguyễn Hải Duy', 1, '1996-04-23', 'Cầu DIễn Hội - Hoàn Hoàn', 'admin@gmail.com', '123456', 1, 1, 1448950572, 1526007952, 'mtd-avatar1526032872.gif'),
(3, 'MN1', 'tutran', '132', 'Trần Anh Tú', 2, '2010-05-02', 'nhà tú chứ đâu here', 'tu@gmail.com', '321321', 1, 2, 1458132295, 1526010028, 'mtd-avatar1526009994.jpeg'),
...
(23, 'EM5', 'hieu', '197011', 'Phạm Văn Hiếu', 1, '1970-01-01', 'xxx', '', '', 1, 3, 1525488689, 1525800353, ''),
...
(29, 'AD3', 'beo', '197011', 'nguyen hai duy', 1, '1970-01-01', '', '', '1', 1, 1, 1525771278, 1525882320, ''),
(30, 'AD4', 'tieu', '197011', 'nguyen van tieu', 2, '1970-01-01', '', '', '', 1, 1, 1526010241, 1526010250, '');
...
ALTER TABLE `product`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `category_id` (`category_id`,`unit_id`),
