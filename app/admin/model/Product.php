...
class Product extends Main
{
    ...
    public function ajax_load()
    {
        if( isset($_POST['id']) )
        {
          ...
          $item['trademark_id'] = $this->helper->get_option_with_status('product_trademarks',$item['trademark_id']);
          $item['discount_type'] = $this->helper->get_option_properties('discount_type', $item['discount_type']);
