					...
					<form method="post" class="form-horizontal form-label-left" data-parsley-validate enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<p>Dữ liệu từ file cho sản phẩm đã được đẩy lên hệ thống. Vui lòng cài đặt ngay...</p>
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2">
								<button type="submit" class="btn btn-success" name="submit">Cài đặt dữ liệu</button>
							</div>
						</div>
					</form>
