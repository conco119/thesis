<div class="">
	<div class="row">
		<div class="col-md-9">
			<div class="x_panel">
				<div class="x_title">
					<h2>Chi tiết mua hàng của khách hàng <b>{$customer.name}</b><small>[{$customer.code}]</small></h2>
					<br>
					<br>
					<p class="text-left">Số điện thoại: <b>{$customer.phone}</b> -  Địa chỉ: <b>{$customer.address}</b></p>
				...
				<div class="x_content">
					...
					<div class="h_content">
						...
						<a href="?mod=customer&site=index" class="btn btn-primary left"><i
							class="fa fa-bars"></i> Quản lý khách hàng</a>
						<button type="button" class="btn btn-primary" onclick="SetPrint();"><i class="fa fa-print"></i> In</button>
						<div class="clearfix"></div>
					</div>
...
function DetailProduct(customer_id, date){
	$("#DetailProduct .modal-body").load("?mod=customer&site=ajax_load_products", {'id':customer_id, 'date':date});
}
