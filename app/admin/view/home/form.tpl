    ...
    <div class="top_tiles">
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count">{$statis1.customer}</div>
                <h3>Khách hàng</h3>
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count">{$statis1.supplier}</div>
                <h3>Nhà cung cấp</h3>
        ...
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="tile-stats">
                ...
                <div class="count">{$statis1.product}</div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div>
                            ...
                            <ul class="list-unstyled top_profiles scroll-view">
                            	{foreach from=$invnew item=data}
                                <li class="media event">
                                	<a class="pull-left border-aero profile_thumb"> <i class="fa fa-user aero"></i></a>
                                    <div class="media-body">
                                        <a class="title">{$data.code}</a>
                                        <p><strong>{$data.money|number_format} </strong> <small>{$data.created}</small></p>
                                        <p><small>{$data.customer}</small></p>
                                    </div>
                                </li>
                                {/foreach}
                            </ul>
