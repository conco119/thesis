			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="h_content">
						...
						<button type="button" class="btn btn-success" onclick="HandleActive('product_trademarks', 1);"><i class="fa fa-check-square-o"></i> Active</button>
						<button type="button" class="btn btn-default" onclick="HandleActive('product_trademarks', 0);"><i class="fa fa-times-circle"></i> Inactive</button>
						<div class="clearfix"></div>
					</div>
						...
						<tbody>
							...
							<tr id="field{$data.id}">
								...
								<td class="text-right">
									...
									<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#DeleteForm" onclick="LoadDeleteItem('product', {$data.id}, 'ajax_delete_trademarks');"><i class="fa fa-trash-o"></i></button>
								</td>
							</tr>
							{/foreach}
						</tbody>
