...
<body class="cms-index-index">
    <div class="page">
            ...
            <div class="wow">
                <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container'>
                    <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                        <ul>
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/slider_img_1.html'><img src='{$arg.stylesheet}images/slide-img1.jpg' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner" />
                            ...
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='images/slider_img_2.jpg' class="black-text"><img src='{$arg.stylesheet}images/slide-img2.jpg' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner" />
                            ...
                            <div class="slider-items-products">
                                ...
                                <div id="best-seller-slider" class="product-flexslider hidden-buttons">
                                    <div class="slider-items slider-width-col4">
                                        <!-- Item -->
                                    {foreach from=$best_seller item=item}
                                        <div class="item">
                                            <div class="col-item">
                                                {if $item.is_discount eq 1}
                                                    <div class="sale-label sale-top-right">Khuyến mãi</div>
                                                {/if}
                                                <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{$arg.product_folder_link}/{$item.image_name}" class="img-responsive" alt="product-image" /> </a>
                                                    <div class="actions">
                                                ...
                                                <div class="info">
                                                    <div class="info-inner">
                                                        <div class="item-title"> <a title="{$item.name}" href="product_detail.html"> {$item.name} </a> </div>
                                                        <!--item-title-->
                                                        <div class="item-content">
                                                            ...
                                                            <div class="price-box">
                                                                {if $item.is_discount eq 1}
                                                                    <p class="special-price"> <span class="price">{$item.sale_price}đ</span> </p>
                                                                    <p class="old-price"> <span class="price-sep">-</span> <span class="price">{$item.price}đ</span> </p>
                                                                {else}
                                                                    <p class="special-price"> <span class="price">{$item.price}đ</span> </p>
                                                                {/if}
                                                            </div>
                                                        </div>
                                                        <!--item-content-->
                                        ...
                                        <div class="item">
                                            <div class="col-item">
                                                {if $product.is_discount eq 1}
                                                    <div class="sale-label sale-top-right">Khuyến mãi</div>
                                                {/if}
                                                <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{$arg.product_folder_link}/{$product.image_name}" class="img-responsive" alt="product-image" /> </a>

                                                    <div class="qv-button-container"> <a href="quick_view.html" class="qv-e-button btn-quickview-1"><span><span>Quick View</span></span></a> </div>
                                                </div>
                                                <div class="info">
                                                    <div class="info-inner">
                                                        <div class="item-title"> <a title="{$product.name}}" href="product_detail.html">{$product.name}</a> </div>
                                                        <!--item-title-->
                                                        <div class="item-content">
                                                            <div class="ratings">
                                                                <div class="rating-box">
                                                                    <div style="width:{(20*$product.total_rate/$product.number_user_rate)}%" class="rating"></div>
                                                                </div>
                                                            </div>
                                                            <div class="price-box">
                                                                {if $product.is_discount eq 1}
                                                    ...
                                                    <!--info-inner-->
                                                    <div class="actions">
                                                        <button class="button btn-cart" title="Add to Cart" type="button"><span>Thêm vào giỏ</span></button>
                                                    </div>
                                                    <!--actions-->
                                                    <div class="clearfix"> </div>
                                                </div>
                    ...
                    <div id="recommend-slider" class="product-flexslider hidden-buttons">
                        ...
                        {foreach from=$sale_products item=product}
                            <div class="item">
                                <div class="col-item">
                                <div class="sale-label sale-top-right">Khuyến mãi</div>
                                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{$arg.product_folder_link}/{$product.image_name}" class="img-responsive" alt="a" /> </a>
            ...
            <div class="new-pro-slider small-pr-slider" style="overflow:visible">
                <div class="slider-items-products">
                    ...
                    <div id="recommend-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col3">
                            <!-- Item -->
                        {foreach from=$smart_light item=product}
                            <div class="item">
                                <div class="col-item">
                                <div class="sale-label sale-top-right">Khuyến mãi</div>
                                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{$arg.product_folder_link}/{$product.image_name}" class="img-responsive" alt="a" /> </a>
        ...
        <section class="recommend container">
            <div class="new-pro-slider small-pr-slider" style="overflow:visible">
                <div class="slider-items-products">
                    <div class="new_title center">
                        <h2>Ổ CẮM THÔNG MINH</h2>
                    </div>
                    <div id="recommend-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col3">
                            <!-- Item -->
                        {foreach from=$plugin item=product}
                            <div class="item">
                                <div class="col-item">
                                <div class="sale-label sale-top-right">Khuyến mãi</div>
                                    <div class="images-container"> <a class="product-image" title="Sample Product" href="product_detail.html"> <img src="{$arg.product_folder_link}/{$product.image_name}" class="img-responsive" alt="a" /> </a>
                                        ...
                                        <div class="info">
                                            <div class="info-inner">
                                                ...
                                                <div class="item-content">
                                                    ...
                                                    <div class="price-box"> <span class="regular-price"> <span class="price">$422.00</span> </span>
                                                    </div>
                                                </div>
                                                <!--item-content-->
                                            </div>
                                        ...
                                        <div class="info">
                                            <div class="info-inner">
                                                ...
                                                <div class="item-content">
                                                    ...
                                                    <div class="price-box"> <span class="regular-price"> <span class="price">$50.00</span> </span>
                                                    </div>
                                                </div>
                                                <!--item-content-->
                                            </div>
    ...
    <!-- JavaScript -->
    <script type="text/javascript" src="{$arg.common_stylesheet}js/custom.js"></script>
    ...
    <script type="text/javascript" src="{$arg.stylesheet}js/revslider.js"></script>
