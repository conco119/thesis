...
<html>
    <head>
        ...
        <script type="text/javascript" src="{$arg.stylesheet}js/GoogleMapControl.js"></script>
        <script type="text/javascript" src="{$arg.stylesheet}js/validate.js"></script>

        
    </head>
    <body onload="initialize({$arg.map.ip})">
