<?php
/* Smarty version 3.1.30, created on 2018-06-07 22:50:55
  from "/Users/mtd/Sites/htaccess/app/site/view/layouts/category-detail.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b19545f46fdb9_05862107',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd174f17cf1107e6fea187fb29436644bacdcf423' => 
    array (
      0 => '/Users/mtd/Sites/htaccess/app/site/view/layouts/category-detail.tpl',
      1 => 1528386653,
      2 => 'file',
    ),
  ),
...
function content_5b19545f46fdb9_05862107 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="row">
        <section class="col-main col-sm-9 col-sm-push-3 wow">
          <div class="category-title">
            <h1><?php echo $_smarty_tpl->tpl_vars['parent']->value['name'];?>
</h1>
          </div>
          <!-- category banner -->
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1">
                  ...
                  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['random_product']->value, 'item');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['item']->value) {
?>
                    <div class="item"> <a href="#"><img alt="category-banner" src="<?php echo $_smarty_tpl->tpl_vars['arg']->value['product_folder_link'];?>
/<?php echo $_smarty_tpl->tpl_vars['item']->value['image_name'];?>
"></a>
                      <div class="cat-img-title cat-bg cat-box">
                        <h2 class="cat-heading" style='color:red'><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</h2>
...
?>
              <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6" style='height:50%;'>
                <div class="col-item">
                  <?php if ($_smarty_tpl->tpl_vars['product']->value['is_discount'] == 1) {?>
                    <div class="sale-label sale-top-right">Khuyến mãi</div>
                  <?php }?>
                  <div class="images-container"> <a class="product-image" title="<?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
" href="./?mc=productdetail&n=<?php echo $_smarty_tpl->tpl_vars['product']->value['slug_name'];?>
"> <img src="<?php echo $_smarty_tpl->tpl_vars['arg']->value['product_folder_link'];?>
/<?php echo $_smarty_tpl->tpl_vars['product']->value['image_name'];?>
" class="img-responsive" alt="a" /> </a>
                  ...
                  <div class="info">
                    <div class="info-inner">
                      <div class="item-title"> <a title=" Sample Product" href="product_detail.html"> <?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
</a> </div>
                      <!--item-title-->
                      <div class="item-content">
                        <div class="ratings">
                          <div class="rating-box">
                            <div style="width:<?php echo (20*$_smarty_tpl->tpl_vars['item']->value['total_rate']/$_smarty_tpl->tpl_vars['item']->value['number_user_rate']);?>
%" class="rating"></div>
                          </div>
                        </div>
                        <div class="price-box">
                          <?php if ($_smarty_tpl->tpl_vars['product']->value['is_discount'] == 1) {?>
                              <p class="special-price"> <span class="price"><?php echo $_smarty_tpl->tpl_vars['product']->value['sale_price'];?>
đ</span> </p>
                              <p class="old-price"> <span class="price-sep">-</span> <span class="price"><?php echo $_smarty_tpl->tpl_vars['product']->value['price'];?>
đ</span> </p>
                          <?php } else { ?>
                              <p class="special-price"> <span class="price"><?php echo $_smarty_tpl->tpl_vars['product']->value['price'];?>
đ</span> </p>
                          <?php }?>
        ...
        <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow">
          <div class="side-nav-categories">
            ...
            <div class="box-content box-category">
              <ul>
              <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['all_child']->value, 'child');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['child']->value) {
?>
                <li> <a class="active" href="./?mc=category&site=index&c=<?php echo $_smarty_tpl->tpl_vars['child']->value['link'];?>
"> <?php echo $_smarty_tpl->tpl_vars['child']->value['name'];?>
 </a> <span class="subDropdown minus"></span>
                <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['child']->value['child'], 'child_child');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['child_child']->value) {
?>
                  <ul class="level0_415" style="display:block">
                    <li>
                      <a href="./?mc=category&site=index&c=<?php echo $_smarty_tpl->tpl_vars['child_child']->value['link'];?>
"> <?php echo $_smarty_tpl->tpl_vars['child_child']->value['name'];?>
 </a>
                    </li>
                  </ul>
                <?php
