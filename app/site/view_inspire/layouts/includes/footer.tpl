    ...
    <div class="footer-middle container">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="contacts-info">
                <address>
                    <i class="add-icon">&nbsp;</i>{$info.info.address}
                </address>
                <div class="phone-footer"><i class="phone-icon">&nbsp;</i>{$info.info.phone}</div>
                <div class="email-footer"><i class="email-icon">&nbsp;</i> <a href="mailto:support@magikcommerce.com">{$info.info.email}</a> </div>
            </div>
        </div>
    </div>
