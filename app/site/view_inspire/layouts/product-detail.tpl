                ...
                <div class="product-img-box col-lg-6 col-sm-6 col-xs-12">
                  ...
                  {$i=1}
                    {foreach from=$product.images key=k item=image}
                        <li class="moreview_thumb thumb_{$i}"> <img class="moreview_thumb_image" src="{$arg.product_folder_link}/{$image.name}">
                            <img class="moreview_source_image {if $image.is_showed eq 1} moreview_thumb_active {/if}" src="{$arg.product_folder_link}/{$image.name}" alt="">
                            <span class="roll-over">Roll over image to zoom in</span>
                            <img style="position: absolute;" class="zoomImg" src="{$arg.product_folder_link}/{$image.name}">
                  {$i++}
                    {/foreach}
                  </ul>
...
<script type="text/javascript" src="{$arg.stylesheet}js/jquery.jcarousel.min.js"></script>
<script type="text/javascript" src="{$arg.stylesheet}js/cloudzoom.js"></script>
